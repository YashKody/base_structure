...
import 'framework/repository/dummy.dart';

export 'package:objectbox/objectbox.dart'; // so that callers only have to import this file

final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
    id: const obx_int.IdUid(1, 6461729546208493944),
    name: 'Dummy',
    lastPropertyId: const obx_int.IdUid(1, 5859303057480351289),
    flags: 0,
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
        id: const obx_int.IdUid(1, 5859303057480351289),
        name: 'id',
        type: 6,
        flags: 1,
      ),
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
    ...
    entities: _entities,
    lastEntityId: const obx_int.IdUid(1, 6461729546208493944),
